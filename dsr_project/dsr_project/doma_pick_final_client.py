...
class DomaPickClient(Node):
    def __init__(self):
        super().__init__('doma_pick_client')
        self._client = ActionClient(self, BrushingAction, '/dsr01/do_doma_pick_action')
    ...
    def send_goal(self):
        ...
        self.get_logger().info("Sending Goal (Safety Mode)...")
    ...
    def feedback_cb(self, msg):
        fb = msg.feedback
        print(f"\r[Safe Pick] {fb.feedback_string}   ", end="")
