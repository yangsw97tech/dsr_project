...
dsr_project/dsr_project 내의 test_gui, firebase_publishing2.py, firebase_final.html, firebase.html, erasing_stop_server.py, brushing_stop_server.py, oiling_stop_server.py, Doma_a_pick_server.py, Doma_a_place_server.py, erasing_action_client.py, brushing_action_client.py, oiling_action_client.py, cam_subscriber, main_node_gem.py

dsr_project/launch 내의 board_pipeline.launch.py

my_robot_interfaces/action 내의 BrushingAction.action
